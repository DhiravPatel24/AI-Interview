...
function Feedback({params}) {
    ...
    const GetFeedback = async () => {
      try {
          ...
          const filteredResults = result.filter(item => item.mockId === params.interviewId);
  
          if (filteredResults.length > 0) {
              console.log("Filtered Results:", filteredResults);
              setFeedbackList(filteredResults);
          } else {
              console.log("No feedback records found for the given interview ID.");
          }
      } catch (error) {
